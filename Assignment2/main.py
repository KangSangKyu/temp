...
from network import VGG16_A, VGG16_B, VGG16_C, VGG16_D, VGG16_E, VGG16_F, VGG16_G
...
def get_model(config):
    ...
    elif config.model_fn == 'VGG16_F':
      model = VGG16_F(dropout_ratio = config.dropout_ratio)
    elif config.model_fn == 'VGG16_G':
      model = VGG16_G(dropout_ratio = config.dropout_ratio)
    else:
